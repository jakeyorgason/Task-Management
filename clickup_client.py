...
class ClickUpClient:
    ...
    def get_filtered_team_tasks(
        ...
        *,
        ...
        ClickUp returns up to 100 tasks per page. This method paginates until the
        API returns no more tasks or page_limit is reached.
        """
        ...
        for page in range(page_limit):
            ...
            payload = self._request("GET", f"/team/{self.config.team_id}/task", params=params)
    ...
    def add_task_comment(self, task_id: str, comment_text: str, *, notify_all: bool = False) -> Dict[str, Any]:
        ...
        return self._request(
            ...
            json={"comment_text": comment_text.strip(), "notify_all": notify_all},
        )
